...
export function parseMarkdownMatches<T>(markdown: string, pattern: RegExp, mapMatch: (match: RegExpMatchArray) => [string, T] | null, options?: { duplicate?: 'error' | 'replace' }): Map<string, T>;
